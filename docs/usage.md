...
A request that cannot reach Glue at all, such as from a network with an Athena VPC endpoint but no route to Glue, also turns the fallback off for the rest of that connection.
